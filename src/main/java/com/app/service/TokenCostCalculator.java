...
public class TokenCostCalculator {
    ...
    public double calculateCost(String modelName, long promptTokens, long completionTokens) {
        ...
        if (lower.contains("llama") || lower.contains("groq")) {
            promptRate = 0.00059 / 1000;
            completionRate = 0.00079 / 1000;
        } else if (lower.contains("gemini-1.5-flash") || lower.contains("gemini-flash")) {
            ...
            promptRate = 0.0030 / 1000;
            completionRate = 0.0150 / 1000;
        }
